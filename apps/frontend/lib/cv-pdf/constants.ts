...
export const CV_PDF_LEFT_INNER_WIDTH_PT = 164 - 2 * CV_PDF_LEFT_CELL_PADDING_PT;

/**
 * X position where right-column body text begins (`layout.ts`: page `paddingHorizontal` + sidebar
 * `width` + `marginRight` + right column `paddingHorizontal`).
 */
export const CV_PDF_RIGHT_COLUMN_INNER_LEFT_PT = 14 + 164 + 8.6 + 5;
