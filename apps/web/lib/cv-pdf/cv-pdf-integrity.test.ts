...
import { CV_PDF_RIGHT_COLUMN_INNER_LEFT_PT } from "@/lib/cv-pdf/constants";
import {
  flattenCvPdfTextForSubstringMatch,
  normalizeCvPdfExtractedText,
} from "@/lib/cv-pdf/pdf-text-normalize";
import { extractPdfPageTextItems, pdfParse } from "@/lib/cv-pdf/cv-pdf-pdfjs";
import { renderCvPdfToBuffer } from "@/lib/cv-pdf/cv-pdf-vitest-helpers";
import { buildCvPdfRequiredSubstrings, cvData } from "@portfolio/cv";
